defmodule Jidoka.Subagent.Definition do
  @moduledoc false
  ...
  def validate_agent_module(module) when is_atom(module) do
    cond do
      ...
      missing = missing_functions(module) ->
        {:error, "subagent #{inspect(module)} is not a valid Jidoka subagent; missing #{Enum.join(missing, ", ")}"}
  ...
  @spec agent_name(module()) :: {:ok, String.t()} | {:error, String.t()}
  ...
  @spec subagent_names([map()]) :: {:ok, [String.t()]} | {:error, String.t()}
  def subagent_names(subagents) when is_list(subagents) do
    ...
    if Enum.uniq(names) == names do
      ...
      {:error, "subagent names must be unique within a Jidoka agent"}
    end
  end

  @spec new(module(), keyword()) :: {:ok, map()} | {:error, String.t()}
  ...
  @spec normalize_available_subagents([module()] | %{required(String.t()) => module()}) ::
          {:ok, %{required(String.t()) => module()}} | {:error, String.t()}
  ...
  def normalize_available_subagents(other),
    do:
      {:error,
       "available_subagents must be a list of Jidoka agent modules or a map of name => module, got: #{inspect(other)}"}

  @spec resolve_subagent_name(String.t(), %{required(String.t()) => module()}) ::
  ...
  @spec normalize_target(term()) :: {:ok, term()} | {:error, String.t()}
  ...
  @spec normalize_forward_context(term()) :: {:ok, term()} | {:error, String.t()}
  ...
  @spec normalize_result(term()) :: {:ok, :text | :structured} | {:error, String.t()}
  ...
  defp ensure_unique_registry_name(name, acc) do
    if Map.has_key?(acc, name) do
      {:error, "subagent names must be unique within a Jidoka subagent registry"}
    else
      :ok
    end
  end
