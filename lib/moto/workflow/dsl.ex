defmodule Moto.Workflow.Dsl do
  @moduledoc false

  alias Moto.Workflow.Dsl.{AgentStep, FunctionStep, ToolStep}

  @workflow_section %Spark.Dsl.Section{
    name: :workflow,
    describe: """
    Configure the immutable Moto workflow contract.
    """,
    schema: [
      id: [
        type: :any,
  ...
  @tool_step_entity %Spark.Dsl.Entity{
    ...
    schema: [
      ...
      module: [
        type: :atom,
        required: true,
        doc: "A `Moto.Tool` or generic Jido Action-backed module."
      ],
      input: [
        type: :any,
        required: false,
  ...
  @agent_step_entity %Spark.Dsl.Entity{
    name: :agent,
    describe: "Call a compiled Moto-compatible agent or runtime-provided imported agent.",
    target: AgentStep,
    imports: [Moto.Workflow.Ref],
    ...
    schema: [
      ...
      agent: [
        type: :any,
        required: true,
        doc: "A Moto-compatible agent module or `{:imported, key}` runtime agent reference."
      ],
      prompt: [
        type: :any,
        required: true,
