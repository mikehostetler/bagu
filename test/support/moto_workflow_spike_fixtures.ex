defmodule MotoTest.WorkflowSpike.AddAmount do
  @moduledoc false
...
defmodule MotoTest.WorkflowSpike.DoubleValue do
  @moduledoc false
...
defmodule MotoTest.WorkflowSpike.Fail do
  @moduledoc false
...
defmodule MotoTest.WorkflowSpike do
  @moduledoc false

  alias Jido.Runic.ActionNode
  alias MotoTest.WorkflowSpike.{AddAmount, DoubleValue, Fail}
  ...
  def pipeline_workflow do
    ...
    Workflow.new(name: :moto_workflow_spike_pipeline)
  ...
  def failing_workflow do
    ...
    Workflow.new(name: :moto_workflow_spike_failure)
...
defmodule MotoTest.WorkflowSpike.AgentServerAgent do
  @moduledoc false

  use Jido.Agent,
    name: "moto_workflow_spike_agent",
  ...
  def build_workflow, do: MotoTest.WorkflowSpike.pipeline_workflow()
end
